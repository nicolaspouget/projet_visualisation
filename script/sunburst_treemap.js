...
function update(val, val2){
    ...
    //treemap
    d3.json("../data/treemap.json", function(err, res) {
        if (!err) {
    ...
    if(val2===undefined){
        //sunburst
        d3.json("../data/sunburst.json", function(err, res) {
            if (!err) {
...
function main(o, data) {
    ...
    function display(d) {
        ...
        //On change l'opacité de la figure en fonction de sa valeur
        g.selectAll("rect")
        ...
        function transition(d) {
            ...
            // Mise à jour après les nouveaux élements
